...
@interface ParentingView () <UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UIActionSheetDelegate>
...
- (void)viewDidLoad {
    ...
    self.screenName = @"Parenting Screen";
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    if(![[NSUserDefaults standardUserDefaults] boolForKey:@"LanguageSettings"]) {
        ...
        [self.navigationController.navigationBar.topItem setTitle:@"PARENTING"];
        self.navigationController.navigationBar.titleTextAttributes = @{NSForegroundColorAttributeName: [UIColor whiteColor]};
        
    }else {
        
        [self.navigationController.navigationBar.topItem setTitle:@"पेरेंटिंग"];
        self.navigationController.navigationBar.titleTextAttributes = @{NSForegroundColorAttributeName: [UIColor whiteColor]};
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString *CellIdentifier = @"parenting";
    
    ParentingCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
    ...
    cell.parentingTitle.text = [[myArray objectAtIndex:indexPath.row]objectForKey:@"title"];
    ...
    cell.discriptionleabel.attributedText  = attributedString;
    if (IS_IPAD)
    {
        cell.discriptionleabel.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:20.0];
        
    }else {
        
        cell.discriptionleabel.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:13.0];
    ...
    //
    //
    //    cell.discriptionleabel.font = [UIFont fontWithName:@"HelveticaNeue-Light" size:13.0f];
    //      cell.discriptionleabel.attributedText = attributedString;
    ...
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:imageurl]
                                         ...
                                         timeoutInterval:60];
    [cell.parentingImage setImageWithURLRequest:request
                               placeholderImage:nil
                                        success:^(NSURLRequest *request, NSHTTPURLResponse *response, UIImage *image) {
                                            
                                            cell.parentingImage.image = image;
    ...
    cell.LikeCountDisplayButton.layer.cornerRadius = 13; // this value vary as per your desire
    cell.LikeCountDisplayButton.clipsToBounds = YES;
    
    likes = [[myArray objectAtIndex:indexPath.row]objectForKey:@"likes"];
    
    NSLog(@"likescount ====%@",likes);
    
    cell.LikeCountDisplayButton.titleLabel.font = [UIFont systemFontOfSize:12];

    [cell.LikeCountDisplayButton setTitle:likes forState:UIControlStateNormal];
    [cell.LikeCountDisplayButton  setTitleColor: [UIColor blackColor] forState: UIControlStateNormal];
    
    cell.LikeCountDisplayButton.tag = 888;
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGSize mElementSize  = CGSizeMake(300, 377);
    
    CGSize mElementSize1  = CGSizeMake(350, 377);
    CGSize mElementSize2  = CGSizeMake(380, 377);
    CGSize mElementSize3  = CGSizeMake(700, 545);
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        {
            // iPhone Classic
            //CGSize mElementSize  = CGSizeMake(300, 331);
            return mElementSize;
        }
...
-(void)LikeClick:(UIButton *)sender{
        ...
        
    {
        ...
        indexPath = [self.myCollectionView indexPathForItemAtPoint:[self.myCollectionView convertPoint:sender.center fromView:sender.superview]];
